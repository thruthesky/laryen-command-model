...
## 현재 상태(메트릭) — iter 24
- 모델: d_model 192·layers 3, **학습 seed 고정**(재현성). 정확도 **exact 0.964**, 홀드아웃 0.97.
- 강건성: 공백·유사발음·구어체·존댓말·edge. 라우팅: 단일/존댓말/영어별칭/은어→sml /
  복합·상대·부정·다중→fallback. monsters FP 0·TP≥0.8.
