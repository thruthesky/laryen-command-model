...
ANSWER_INTENTS = [
    ...
    "query_current_zone",          # "지금 사냥하는 곳 어디야"(*현재 위치* — currentZoneNotifier).
                                   #   ⚠️ query_recommended_hunt_zone(추천)과 *반드시 구분*.
    "query_recommended_hunt_zone", # "내 레벨에 맞는 사냥터 어디야"(추천 — recommendHuntZone(lv))
