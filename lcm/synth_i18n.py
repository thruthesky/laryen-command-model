...
I18N_COMMAND: dict[str, dict[str, list[str]]] = {
    ...
    "hunt": {  # {action: hunt}
        "ko": ["사냥해", "사냥하자", "몬스터 잡아", "사냥 시작"],
        "en": ["hunt", "start hunting", "kill monsters", "let's hunt"],
        "zh": ["打怪", "开始打怪", "去刷怪", "我们去打怪"],
        "ja": ["狩りして", "狩りを始めて", "モンスター倒して", "狩りしよう"],
    },
    "stop": {  # {action: stop}
        "ko": ["멈춰", "그만", "정지", "스톱"],
    ...
    "open_menu": {  # {action: open_menu}
        "ko": ["메뉴 열어", "메뉴 보여줘", "메뉴"],
        "en": ["open menu", "show menu", "menu"],
        "zh": ["打开菜单", "显示菜单", "菜单"],
        "ja": ["メニュー開いて", "メニューを見せて", "メニュー"],
    },
